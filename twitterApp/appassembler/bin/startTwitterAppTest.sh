...
exec "$JAVACMD" $JAVA_OPTS  \
  -classpath "$CLASSPATH" \
  -Dapp.name="startTwitterAppTest.sh" \
  -Dapp.pid="$$" \
  -Dapp.repo="$REPO" \
  -Dapp.home="$BASEDIR" \
  -Dbasedir="$BASEDIR" \
  master2016.TwitterApp \
  1 TGOBzn883yUCgcCOwVxdpAnmE QB1NIchNnrxbNLLsUaF3KbKzC15sSkhhpjER5MVDtopHK0Cg2v 3316962501-Q1OFmP3hCbkZqTvmiokPCh3vU4eWVStbosP7CkM 6zSS9YnMgJTW4BZx30C9ApMZhHQk0yvNXMWSQsghGKJhk localhost:2181 /home/tobias/workspace/twitterApp/src/main/conf/tweetsExample.log "$@"
